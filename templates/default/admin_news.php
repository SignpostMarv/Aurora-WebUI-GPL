...
?>
				<tr id="news_<?php echo esc_attr($newsItem->NoticeID()); ?>">
					...
					<td headers=news-manager-action><a href="<?php echo esc_attr(Template\link('/admin/news/edit/' . rawurlencode(Template\squishUUID($newsItem->NoticeID())))); ?>"><?php echo esc_html(__('Edit')); ?></a></td>
					<td headers=news-manager-action><a href="<?php echo esc_attr(Template\link('/admin/news/delete/' . rawurlencode(Template\squishUUID($newsItem->NoticeID())))); ?>"><?php echo esc_html(__('Delete')); ?></a></td>
				</tr>
<?php
	}
?>
