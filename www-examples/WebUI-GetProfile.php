<?php
	...
	var_dump($WebUI->GetProfile(
		$user // we can use either User objects
	),$WebUI->GetProfile( // because GetProfile wraps to a registry method, this should always be the same instance unless the user logged in/out between calls.
